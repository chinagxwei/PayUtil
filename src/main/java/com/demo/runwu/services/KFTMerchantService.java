...
public class KFTMerchantService {
    ...
    public static void init() throws Exception {
        ...
        service.setSftpAccountName("2024031400105169");//sftp账号,与商户账户编号相同（MerchantId）
        service.setSftpPassword("");//sftp密码 测试环境:账号后6位
    ...
    public void testSecmerchantBaseinfoAdd(){
        ...
        reqDTO.setCertPath("2017081400114587.zip");//SFTP目录下的地址，默认在mpp目录下
    ...
    public void testGenMd5FileDigest() {
        try {
            String filePath = "C:\\Users\\Administrator\\Documents\\Tencent Files\\569596742\\FileRecv\\20181225112606001.zip";
            String certDigest = KFTMerchantService.md5File(filePath);
    ...
    public void testUploadFile() {
        try {
            String localFilePath = "D:/kft/2017081400114587.zip";
